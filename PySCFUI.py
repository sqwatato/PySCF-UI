...
# verbose_option = st.selectbox("Verbose", index=2, options=[
    ...
    st.write("The available Basis Stack Exchange libraries are valid for C, H, O, N, F, S, and P. While they also work for many other atoms, some atoms may not have a corresponding set with that basis, in which case the UI will return an error.")
