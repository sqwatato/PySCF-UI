...
st.write("*Please note that the PySCF basis sets may not have sets for the particular atoms you have selected. If a basis set cannot be found, the UI will return an error. For more information on this, please see the Quickstart Guide.*")
