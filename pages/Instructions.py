...
st.write("Please note that not all of the basis sets exist for all the atoms; thus, the UI will throw an error if a basis set has not been found for a particular atom. To see the list of all the basis sets offered by PySCF, and the atoms for which those basis sets are included, please visit the link below:"
